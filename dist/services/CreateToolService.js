...
var CreateToolService = /** @class */ (function () {
    function CreateToolService() {
    }
    CreateToolService.prototype.execute = function (_a) {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        ...
                        tool = toolsRepository.create({
                            title: title,
                            link: link,
                            description: description,
                            tags: tags,
                        });
                        return [4 /*yield*/, toolsRepository.save(tool)];
                    case 1:
                        _b.sent();
...
exports.default = CreateToolService;
